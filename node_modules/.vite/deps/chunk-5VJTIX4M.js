...
var ICONS = {
  add: async () => (await import("./add-K543WXN7.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-6GTV24L2.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-2NTKS3BV.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-B7E2WTRF.js")).appStoreSvg,
  apple: async () => (await import("./apple-37MPMMTS.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-ZZFKBAVT.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-A5CHJEN2.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-GUYP74LF.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-2BYL4BP7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-6LRBYBZD.js")).bankSvg,
  browser: async () => (await import("./browser-UPW6I64Z.js")).browserSvg,
  card: async () => (await import("./card-7XWHNK3I.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-XNUR3XKY.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-IMVP2RWA.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-XTLUBNDM.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-UOHDQFIW.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-GNOJLZ4Z.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-QMRATFFO.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-PS5BJMV6.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-4XT7EN6Q.js")).clockSvg,
  close: async () => (await import("./close-ASL2TWKP.js")).closeSvg,
  compass: async () => (await import("./compass-ILGSK2IU.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ZDUPAVOT.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-S2BOE42L.js")).copySvg,
  cursor: async () => (await import("./cursor-Z7DCI5LM.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-KCI5UQ3G.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-XRUZIBFM.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-ZIWQSJH3.js")).disconnectSvg,
  discord: async () => (await import("./discord-RZAOB6LJ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-UNR5M6D4.js")).etherscanSvg,
  extension: async () => (await import("./extension-XNCKPH4O.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CNXT4PO5.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-STCRKLF4.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-JLDOP2GB.js")).farcasterSvg,
  filters: async () => (await import("./filters-O5367KCE.js")).filtersSvg,
  github: async () => (await import("./github-4RAKJWQ7.js")).githubSvg,
  google: async () => (await import("./google-7TG4CINT.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-JOQ3I6UU.js")).helpCircleSvg,
  image: async () => (await import("./image-3IA7BET7.js")).imageSvg,
  id: async () => (await import("./id-X235U7HT.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-IWZRE4XG.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-P5TEHZOT.js")).lightbulbSvg,
  mail: async () => (await import("./mail-4E3LPRAI.js")).mailSvg,
  mobile: async () => (await import("./mobile-ZQPBPY4V.js")).mobileSvg,
  more: async () => (await import("./more-AW6SUJAT.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-CS7GIXSL.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-4WSE3DB5.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-A74XBSGK.js")).offSvg,
  playStore: async () => (await import("./play-store-W5STJ6EF.js")).playStoreSvg,
  plus: async () => (await import("./plus-BVN5T42M.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-EFIPVHLG.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-YNCPF73V.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-3MN6U7JQ.js")).refreshSvg,
  search: async () => (await import("./search-2DV4QVEG.js")).searchSvg,
  send: async () => (await import("./send-4BNDZPEB.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-HVTOJEZY.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-TWNI3BCU.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-NNW2TKWZ.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-HRQ4J7KL.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-WV3DYW43.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-7O5G7PYU.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-VKWC22XM.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-JONQ32GR.js")).twitchSvg,
  twitter: async () => (await import("./x-VUCAI5EG.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-PZXPJYJL.js")).twitterIconSvg,
  verify: async () => (await import("./verify-VWWWUDAC.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-ZSJZOP2S.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-EI2CPBKV.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-LQOIT3JI.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-LQOIT3JI.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-LQOIT3JI.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-WBA5X5JI.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-CEGGVEUI.js")).warningCircleSvg,
  x: async () => (await import("./x-VUCAI5EG.js")).xSvg,
  info: async () => (await import("./info-WT4KAQUI.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-TSTFT3R6.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-FHRJQDWU.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5VJTIX4M.js.map
