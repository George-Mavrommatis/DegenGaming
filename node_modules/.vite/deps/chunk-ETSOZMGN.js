...
var ICONS = {
  add: async () => (await import("./add-BH6OR5WI.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-BSKJPCFJ.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-WDJJCGVT.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-6A5TIOKG.js")).appStoreSvg,
  apple: async () => (await import("./apple-4TH4FNKX.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-QPCD2ABF.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-Q27EQEAF.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-CYTLXAZ6.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LW3IQ3VH.js")).arrowTopSvg,
  bank: async () => (await import("./bank-IFVK4ZQB.js")).bankSvg,
  browser: async () => (await import("./browser-XJAU46KV.js")).browserSvg,
  card: async () => (await import("./card-QFCWD3HZ.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-6TIO3IE7.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-T7NA6JHC.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-OOTWIOFC.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-SALFZQPT.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-EJIKHD5L.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-D6D5IOAF.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-2LW6K5JA.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-6GGO6SKT.js")).clockSvg,
  close: async () => (await import("./close-OU34XKAL.js")).closeSvg,
  compass: async () => (await import("./compass-UJGKVFRZ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-WRDCAR4H.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-DAVZSWUI.js")).copySvg,
  cursor: async () => (await import("./cursor-CYJ7XUX5.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-Z62QFBYM.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-OX3C776L.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-NFEZHQEY.js")).disconnectSvg,
  discord: async () => (await import("./discord-EYZ47U3T.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-WL4E2ONQ.js")).etherscanSvg,
  extension: async () => (await import("./extension-XDCCB4KL.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-HRYQYBWZ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-YONT6CSP.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-2BLCXL4O.js")).farcasterSvg,
  filters: async () => (await import("./filters-PEAX3Q7J.js")).filtersSvg,
  github: async () => (await import("./github-N7N6TYYE.js")).githubSvg,
  google: async () => (await import("./google-DWOATFKG.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-XM2OYRDR.js")).helpCircleSvg,
  image: async () => (await import("./image-RWTLI42D.js")).imageSvg,
  id: async () => (await import("./id-UARRHFTL.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-AEQ6MYG6.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-53FD3RRR.js")).lightbulbSvg,
  mail: async () => (await import("./mail-G6NFVITK.js")).mailSvg,
  mobile: async () => (await import("./mobile-DT7OUUUQ.js")).mobileSvg,
  more: async () => (await import("./more-JHJYM5SH.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-PHK547J5.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-M67F7I6V.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-LWIYNTDS.js")).offSvg,
  playStore: async () => (await import("./play-store-HIYWZYSS.js")).playStoreSvg,
  plus: async () => (await import("./plus-IL5T6TRZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-UY52MLGY.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-5DWSEVVY.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-5TXEDKBP.js")).refreshSvg,
  search: async () => (await import("./search-5DARBQ6M.js")).searchSvg,
  send: async () => (await import("./send-H2APRVI3.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-EK272DW7.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-ZTNUIQ5E.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-EBHWCCGA.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-BWHIGR7D.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-WMCXIYDZ.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-W3DNE6QH.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-PATFEL3R.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-YHLKUUPA.js")).twitchSvg,
  twitter: async () => (await import("./x-WHPVRNTW.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-K6EBRFSI.js")).twitterIconSvg,
  verify: async () => (await import("./verify-KE3LZCLG.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-YWVRNSV5.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-XDLAL5UZ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-MGOH3EQH.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-MGOH3EQH.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-MGOH3EQH.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-CVCC63U6.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-ZUOLZ5A4.js")).warningCircleSvg,
  x: async () => (await import("./x-WHPVRNTW.js")).xSvg,
  info: async () => (await import("./info-7NE4EUR4.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-QINJXQK5.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-EJM3OTL7.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ETSOZMGN.js.map
