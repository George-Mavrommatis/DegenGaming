...
var ICONS = {
  add: async () => (await import("./add-4P3WVF2X.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-ULOP272R.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-MJGTDZTT.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-F65ANH5P.js")).appStoreSvg,
  apple: async () => (await import("./apple-K5P7HCBU.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-SLRZXXDJ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-GID7J5QK.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-P7B4YC43.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-BGKJTJZR.js")).arrowTopSvg,
  bank: async () => (await import("./bank-CBTNTHVO.js")).bankSvg,
  browser: async () => (await import("./browser-Y44QFOFB.js")).browserSvg,
  card: async () => (await import("./card-I3QBOUOV.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ZS773UAP.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-5TR25AZB.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-USPUVA2W.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-VGF5MJNW.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-HGRU2X2N.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-2LLCCZA4.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-HHLBGR4Z.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-X4ERJYVU.js")).clockSvg,
  close: async () => (await import("./close-CW26PIWC.js")).closeSvg,
  compass: async () => (await import("./compass-BOWBJ366.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-Q5WDQKJA.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-I4BDXTH5.js")).copySvg,
  cursor: async () => (await import("./cursor-WSEUDORX.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-AQ5LMNAT.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-CB2ROI3P.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-4R2JAJ5T.js")).disconnectSvg,
  discord: async () => (await import("./discord-2B4AVCIA.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-4IGCV6E4.js")).etherscanSvg,
  extension: async () => (await import("./extension-IGUHWXMQ.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-TT7X22NY.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-TTJISWIP.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-6MFZG4C5.js")).farcasterSvg,
  filters: async () => (await import("./filters-OF3PZJA7.js")).filtersSvg,
  github: async () => (await import("./github-LHNCFGKQ.js")).githubSvg,
  google: async () => (await import("./google-WGNDEVNN.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-OO2KOBI2.js")).helpCircleSvg,
  image: async () => (await import("./image-UEP2EYHP.js")).imageSvg,
  id: async () => (await import("./id-RZP7MJBX.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-R4NZCRSU.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-YV7E4VVQ.js")).lightbulbSvg,
  mail: async () => (await import("./mail-NZKEFRGU.js")).mailSvg,
  mobile: async () => (await import("./mobile-FPLGZBTG.js")).mobileSvg,
  more: async () => (await import("./more-IOL7TLMO.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-T43PV6DW.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-BOT4KDGO.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-Y7IQ62ZG.js")).offSvg,
  playStore: async () => (await import("./play-store-5Q6DYT2H.js")).playStoreSvg,
  plus: async () => (await import("./plus-6C55J2GX.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-PUU5CYLY.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-7GNE7F4N.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-2CPWGNAY.js")).refreshSvg,
  search: async () => (await import("./search-FSRBYBQW.js")).searchSvg,
  send: async () => (await import("./send-JGWBOMAX.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-C6BJ5SS7.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-I7DTYFQR.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-WCBWAU32.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-RZO56KFB.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-BNTMOJGU.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-KXVMNDNF.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-4NXTO5CY.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-WTGYTCGZ.js")).twitchSvg,
  twitter: async () => (await import("./x-3VVW6WQ4.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-LL4W5GF6.js")).twitterIconSvg,
  verify: async () => (await import("./verify-APDUKSKF.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-CMYGPEML.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-BZRK2V3H.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-VD5HUL25.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-VD5HUL25.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-VD5HUL25.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-SMZX65TR.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-IB5VDPEB.js")).warningCircleSvg,
  x: async () => (await import("./x-3VVW6WQ4.js")).xSvg,
  info: async () => (await import("./info-VCMFLVF6.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-7AMDNSHP.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-QZSCWQVV.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5R6ZRJBJ.js.map
