...
var ICONS = {
  add: async () => (await import("./add-KN2CB7J2.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-JRTZKIAK.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-QL5YHEJE.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-QSAMD5EX.js")).appStoreSvg,
  apple: async () => (await import("./apple-BUYD7H3E.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-XXLSB7RL.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-VLCFFSP4.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-YLIEXRSN.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-A2TTGO4V.js")).arrowTopSvg,
  bank: async () => (await import("./bank-6CWLU37U.js")).bankSvg,
  browser: async () => (await import("./browser-3UNRUDJU.js")).browserSvg,
  card: async () => (await import("./card-LXUIVYYH.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-CZXP4RYC.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-SMS6YZKK.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-HHGDLBHI.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-XQWWMV2U.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-FFZ5IZ6Z.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-7ABW2BTD.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-6SN7XTQU.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-Z55N6FC5.js")).clockSvg,
  close: async () => (await import("./close-GZEIS2E6.js")).closeSvg,
  compass: async () => (await import("./compass-AWAKJNYH.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-7E5YMMN6.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-C35CK5P7.js")).copySvg,
  cursor: async () => (await import("./cursor-CIDOTRRY.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-57YELPO5.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-GRCVTFNY.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-DAN7SYAP.js")).disconnectSvg,
  discord: async () => (await import("./discord-T6SZDIOW.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-2IRRR3G4.js")).etherscanSvg,
  extension: async () => (await import("./extension-SCQBJK6I.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-BX2GNZWC.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-EKZPSC6D.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-OU2E32S6.js")).farcasterSvg,
  filters: async () => (await import("./filters-R5A3DNXX.js")).filtersSvg,
  github: async () => (await import("./github-IYRYF6JF.js")).githubSvg,
  google: async () => (await import("./google-ESX5D2HQ.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-NEUSWGCI.js")).helpCircleSvg,
  image: async () => (await import("./image-YBDQFV3J.js")).imageSvg,
  id: async () => (await import("./id-XM65KM6M.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-RWLFLDYW.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-GZ2DQ3SX.js")).lightbulbSvg,
  mail: async () => (await import("./mail-WZJCEJHA.js")).mailSvg,
  mobile: async () => (await import("./mobile-R744F5HO.js")).mobileSvg,
  more: async () => (await import("./more-IDNQZF6I.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-Z4VWVCAH.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-3MAJY33S.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-TFJ73SCI.js")).offSvg,
  playStore: async () => (await import("./play-store-HMVHC2Y7.js")).playStoreSvg,
  plus: async () => (await import("./plus-JGAEM7U7.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-BCREZCSY.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-YH3ISE5I.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-XRGJPWV2.js")).refreshSvg,
  search: async () => (await import("./search-G7D6ZMPE.js")).searchSvg,
  send: async () => (await import("./send-EHL6XRBL.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-R3PRXO7L.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-3YNMSCWW.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-77RMV2DM.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-OCU7BCOU.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-JNBGQMUO.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-DH6KVUXM.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-FUYZLMP3.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-ZSX7MCTZ.js")).twitchSvg,
  twitter: async () => (await import("./x-KGM3IRZN.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-7IPB75FB.js")).twitterIconSvg,
  verify: async () => (await import("./verify-LSPAD6G6.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-6ZL62XIP.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-VTSSCLF7.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-W4LTTLBI.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-W4LTTLBI.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-W4LTTLBI.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-EJ4FQU2U.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-OPL2EEHV.js")).warningCircleSvg,
  x: async () => (await import("./x-KGM3IRZN.js")).xSvg,
  info: async () => (await import("./info-HCU5DFBA.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-UKVZXNFH.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-AYTSJC2U.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2B36YCD6.js.map
