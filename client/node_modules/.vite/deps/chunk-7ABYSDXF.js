...
var import_dist, import_dist2, import_dist3, _0n, _1n, _2n, _3n, _4n, _5n, _7n, _8n, _9n, _16n, isNegativeLE, FIELD_FIELDS;
...
var import_dist4, import_dist5, import_dist6, _0n2, _1n2, pointPrecomputes, pointWindowSizes, wNAF;
...
function edwards(CURVE, curveOpts = {}) {
  ...
  class Point2 {
    ...
    multiply(scalar) {
      const n = scalar;
      aInRange("scalar", n, _1n3, CURVE_ORDER);
      const { p, f: f2 } = wnaf.cached(this, n, (p2) => normalizeZ(Point2, p2));
      return normalizeZ(Point2, [p, f2])[0];
    }
    ...
    multiplyUnsafe(scalar, acc = Point2.ZERO) {
      const n = scalar;
      aInRange("scalar", n, _0n3, CURVE_ORDER);
      if (n === _0n3)
        return Point2.ZERO;
      if (this.is0() || n === _1n3)
        return this;
    ...
    static fromHex(hex, zip215 = false) {
      ...
      aInRange("pointHex.y", y, _0n3, max);
      const y2 = modP2(y * y);
...
function eddsa(Point2, cHash, eddsaOpts) {
  ...
  function sign2(msg, secretKey, options = {}) {
    ...
    aInRange("signature.s", s, _0n3, CURVE_ORDER);
    const L = Fp2.BYTES;
  ...
  const utils = {
    ...
    toMontgomery(publicKey2) {
      const { y } = Point2.fromBytes(publicKey2);
...
var import_dist7, import_dist8, import_dist9, _0n3, _1n3, _2n2, _8n2, PrimeEdwardsPoint;
...
var import_dist10, import_dist11, import_dist12, os2ip, _DST_scalar;
...
var import_dist13, import_dist14, import_dist15, _0n4, _1n4, _2n3;
...
var import_dist19, import_dist20, import_dist21, end_of_stream, finished, DEFAULT_ENCODING;
...
var import_dist79, import_dist80, import_dist81, WebSocketBrowserImpl, DefaultDataPack, CommonClient;
  ...
  function isValidPublicKey(publicKey2, isCompressed) {
    try {
      ...
      if (isCompressed === false && l !== lengths.publicUncompressed)
        return false;
      return !!Point2.fromBytes(publicKey2);
    } catch (error) {
      return false;
    }
  }
...
var import_dist82, import_dist83, import_dist84, divNearest, DERErr, DER, _0n6, _1n6, _2n5, _3n3, _4n2;
...
function lift_x(x) {
  aInRange("x", x, _1n7, secp256k1_CURVE.p);
  const xx = modP(x * x);
...
var import_dist88, import_dist89, import_dist90, secp256k1_CURVE, secp256k1_ENDO, _0n7, _1n7, _2n6, Fpk1, secp256k1, TAGGED_HASH_PREFIXES, pointToBytes, numTo32b, modP, modN, Point, hasEven, num, schnorr, isoMap, mapSWU, secp256k1_hasher, hashToCurve2, encodeToCurve2;
...
@solana/buffer-layout/lib/Layout.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7ABYSDXF.js.map
